...
public class FinestraLogin extends Finestra
{
    ...
    private JTextField campoPass = new JTextField(10);                          //Campo password
    ...
    private void Disegna()
    {
        ...
        //Barra principale
        ImpostazioniComponente componenteBarraVuota = new ImpostazioniComponente(0, 0, GridBagConstraints.BOTH, 0.0, 1); //Crea impostazioni per barra principale
        ...
        //Logo del programma
        ImpostazioniComponente componenteLogo = new ImpostazioniComponente(0, 1, GridBagConstraints.NONE, 0.0, 1); //Crea impostazioni per logo programma
        ...
        ImpostazioniComponente componenteDati = new ImpostazioniComponente(0, 2, GridBagConstraints.NONE, 0.0, 1); //Crea impostazioni per inserimento dati
        ...
        //Sezione bottoni
        ImpostazioniComponente componenteBottoni = new ImpostazioniComponente(0, 3, GridBagConstraints.NONE, 0.0, 1); //Crea impostazioni per pulsanti
