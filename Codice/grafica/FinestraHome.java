...
public class FinestraHome extends Finestra
{
    ...
    private void Disegna()
    {
        ...
        //Barra vuota
        ImpostazioniComponente componenteBarraVuota = new ImpostazioniComponente(0, 0, GridBagConstraints.BOTH, 1.0, 1); //Crea impostazioni per barra principale
        ...
        //Barra esci
        ImpostazioniComponente componenteBottoneEsci = new ImpostazioniComponente(1, 0, GridBagConstraints.BOTH, 0.0, 1); //Crea impostazioni per il bottone esci sulla barra
        ...
        //Logo del programma
        ImpostazioniComponente componenteLogo = new ImpostazioniComponente(0, 1, GridBagConstraints.NONE, 0.0, 2); //Crea impostazioni per logo programma
        ...
        //Sezione bottoni
        ImpostazioniComponente componenteBottoni = new ImpostazioniComponente(0, 2, GridBagConstraints.NONE, 0.0, 2); //Crea impostazioni per pulsanti
