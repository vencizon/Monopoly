...
public class Bottone extends JButton
{
    ...
    protected Bottone(String nome, String tip, int dimensioneX, int dimensioneY, ActionListener action)
    {
    ...
    protected Bottone(ImageIcon immagine, String nome, String tip, int dimensioneX, int dimensioneY, ActionListener action)
    {
